...
### Changed
- **x402 Payment Beta**: Pinned the installer to `x402-payment-v1.0.1-beta.6` and documented its CLI-based Permit2 and GasFree workflow.
- **x402 CLI Dependency**: The macOS/Linux and Windows installers now install and verify `@bankofai/x402-cli@1.0.1-beta.6` whenever `x402-payment` is present, including upgrades of an existing skill.
...
### Removed
- **Legacy x402 Config Cleanup**: Clean install no longer reports or deletes the obsolete `~/.x402-config.json` file.
...
### Changed
- **Pinned Skills Release**: Updated skills pin from `v1.5.3` to `v1.5.4`.

## [1.4.3] - 2026-03-28

### Changed
- **Pinned Skills Release**: Updated skills pin from `v1.5.2` to `v1.5.3`.
