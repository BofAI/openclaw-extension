...
- **x402-mcp** - MCP wrapper around the x402 CLI
  - Installed via `npx -y @bankofai/x402-mcp@2.6.0-beta.4`
...
The installer clones [BofAI/skills](https://github.com/BofAI/skills) and installs skills from the pinned `v1.4.1` tag by default.
