...
```bash
curl -fsSL https://raw.githubusercontent.com/bankofai/openclaw-extension/refs/heads/pre_release/install.sh | bash
```

Or from source:

```bash
git clone -b pre_release https://github.com/bankofai/openclaw-extension.git
