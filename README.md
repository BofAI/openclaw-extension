...
The installer lets you choose which skills to install during setup. This beta pins the skills repository to `v1.5.15-beta.4`, which includes the CLI-based x402 payment workflow.
...
- `x402-payment` - Pay x402-enabled agent endpoints using `@bankofai/x402-cli@1.0.1-beta.10`, including TRON Permit2 and GasFree flows.
